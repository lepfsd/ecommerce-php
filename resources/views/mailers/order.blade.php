                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h2 class="h2">Recibo de pago</h2>

                                                                <strong>Hola: {{$order->email}}</strong> le enviamos sus datos de la compra
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="{{url('/compras/'.$order->shoppingCartID())}}" target="_blank">See your buy</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
